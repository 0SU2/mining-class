...
clf_2 = ComplementNB()
#Entrenar clasificador 
clf_2.fit(dt_matrix_tr,lab_train)
# Evaluar clasificador 
# Medir desempeño 
predicted = clf_2.predict(dt_matrix_test)
# Medir desempeño 
# Exactitud/Accuracy
acc = accuracy_score(lab_test,predicted)
clf_perf = classification_report(lab_test,predicted)
print(acc)
print(f' ACE Complement --> {acc}')
#print(clf_perf)


print('Complemento de Naive Bayes')
