...
for user_1 in usuarios:
  for user_2 in usuarios:
    if user_1 == user_2:
      continue
    comun = d_voc[user_1].intersection(d_voc[user_2])
    diff_1 = d_voc[user_1].difference(d_voc[user_2])
    diff_2 = d_voc[user_2].difference(d_voc[user_1])
    print(comun)
    print(diff_1)
    print(diff_2)
